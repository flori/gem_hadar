...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<gem_hadar>, ["~> 0.0.7"])
      s.add_runtime_dependency(%q<spruz>, ["~> 0.2.10"])
      s.add_runtime_dependency(%q<dslkit>, ["~> 0.2.7"])
      s.add_runtime_dependency(%q<sdoc>, ["~> 0.2.20"])
      s.add_runtime_dependency(%q<rake>, ["~> 0.9.2"])
    else
      s.add_dependency(%q<gem_hadar>, ["~> 0.0.7"])
      s.add_dependency(%q<spruz>, ["~> 0.2.10"])
      s.add_dependency(%q<dslkit>, ["~> 0.2.7"])
